...
pub struct ThreadSafeType<T> {
    data: Arc<Mutex<T>>,
}

impl<T> ThreadSafeType<T> {
    ...
    /// Create a new ThreadSafeType from an 
    /// 
    /// Arc<Mutex<T>>
    /// 
    /// # Example
    ...
    /// MutexGuard<T> 
    ///
    /// will dereference to the underlying type
    ///
    /// # Example
    ///
    /// Basic usage:
    ...
    ///     info!("The value is true");
    /// } else {
    ///     info!("The value is false");
    /// }
    ///
    /// ```
    ///
...
impl<T> ThreadSafeOptionType<T> {
    ...
    /// Create a new ThreadSafeOptionType from an 
    /// 
    /// Arc<Mutex<Option<T>>>
    ///
    ///
    ...
    /// MutexGuard<Option<T>> 
    ///
    /// will dereference to the underlying Option
    ///
    /// # Example
    ///
    /// Basic usage:
